...
class LoyaltyProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loyalty_program" do
    assert_difference("LoyaltyProgram.count") do
      post loyalty_programs_url, params: { loyalty_program: { guest_id: @loyalty_program.guest_id, membership_tier: @loyalty_program.membership_tier, points_balance: @loyalty_program.points_balance } }
    end
  ...
  test "should update loyalty_program" do
    patch loyalty_program_url(@loyalty_program), params: { loyalty_program: { guest_id: @loyalty_program.guest_id, membership_tier: @loyalty_program.membership_tier, points_balance: @loyalty_program.points_balance } }
