...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference("MenuItem.count") do
      post menu_items_url, params: { menu_item: { description: @menu_item.description, item_name: @menu_item.item_name, popularity_score: @menu_item.popularity_score, price: @menu_item.price } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { description: @menu_item.description, item_name: @menu_item.item_name, popularity_score: @menu_item.popularity_score, price: @menu_item.price } }
