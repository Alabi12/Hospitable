...
class CheckInsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check_in" do
    assert_difference("CheckIn.count") do
      post check_ins_url, params: { check_in: { check_in_time: @check_in.check_in_time, digital_key: @check_in.digital_key, guest_id: @check_in.guest_id } }
    end
  ...
  test "should update check_in" do
    patch check_in_url(@check_in), params: { check_in: { check_in_time: @check_in.check_in_time, digital_key: @check_in.digital_key, guest_id: @check_in.guest_id } }
